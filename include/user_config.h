...
#define MATRIX_TYPE           (3U)                  // тип матрицы: 0 – зигзаг, 1 – параллельная
#define CONNECTION_ANGLE      (1U)                  // угол подключения: 0 - левый нижний, 1 - левый верхний, 2 - правый верхний, 3 - правый нижний
#define STRIP_DIRECTION       (1U)                  // направление ленты с угла: 0 – вправо, 1 – вверх, 2 – влево, 3 – вниз
...
#define TZONE           TZ_Asia_Novosibirsk
#define COUNTRY         ("ru")
